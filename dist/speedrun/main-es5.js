  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function VzF(module, __webpack_exports__, __webpack_require__) {
            ...
            return new Promise(function (resolve, reject) {
              _this.afAuth.onAuthStateChanged(function (user) {
                if (user) {
                  ...
                  _this.router.navigate(['/']); // a logged out user will always be sent to home
      ...
      AuthGuard.ɵfac = function AuthGuard_Factory(t) {
        return new (t || AuthGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"]));
      };
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! C:\Users\miszt\OneDrive\Pulpit\Booker\Booker\src\main.ts */
      "zUnb");
      /***/
    },
    ...
    function sfI(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "StudioMainPageComponent", function () {
        return StudioMainPageComponent;
      });
      /* harmony import */
      ...
      var _services_studio_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      function StudioMainPageComponent_div_2_li_14_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function StudioMainPageComponent_div_2_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var StudioMainPageComponent = /*#__PURE__*/function () {
        function StudioMainPageComponent(studioService, route) {
          var _this2 = this;

          _classCallCheck(this, StudioMainPageComponent);
          ...
          this.makeupStudios = [];
          this.studioService.getStudios().subscribe(function (s) {
            _this2.presentedStudios = s;
            _this2.allStudios = s;

            if (_this2.studioType === _this2.makeupType) {
              _this2.loadMakeupStudios();
            }

            if (_this2.studioType === _this2.hairdresserType) {
              _this2.loadHairdresserStudios();
            }
          });
        }

        _createClass(StudioMainPageComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this3 = this;

            this.route.paramMap.subscribe(function (params) {
              _this3.studioType = params.get('studioType');

              if (_this3.studioType === _this3.makeupType) {
                _this3.loadMakeupStudios();
              }

              if (_this3.studioType === _this3.hairdresserType) {
                _this3.loadHairdresserStudios();
              }

              if (_this3.studioType === _this3.allType) {
                _this3.loadAllStudios();
              }
            });
          }
        }, {
          key: "loadHairdresserStudios",
          value: function loadHairdresserStudios() {
            var _this4 = this;

            this.presentedStudios = this.allStudios.filter(function (studio) {
              return studio.type === _this4.hairdresserType;
            });
          }
        }, {
          key: "loadMakeupStudios",
          value: function loadMakeupStudios() {
            var _this5 = this;

            this.presentedStudios = this.allStudios.filter(function (studio) {
              return studio.type === _this5.makeupType;
            });
          }
        }, {
          key: "loadAllStudios",
          value: function loadAllStudios() {
            this.presentedStudios = this.allStudios;
          }
        }, {
          key: "getStudios",
          value: function getStudios() {}
        }]);

        return StudioMainPageComponent;
      }();

      StudioMainPageComponent.ɵfac = function StudioMainPageComponent_Factory(t) {
        return new (t || StudioMainPageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_studio_service__WEBPACK_IMPORTED_MODULE_1__["StudioService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]));
      };

      StudioMainPageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: StudioMainPageComponent,
        selectors: [["app-studio-main-page"]],
        decls: 3,
        vars: 1,
        consts: [[1, "main-content"], [1, "blurred-background"], ["class", "studio-card", 4, "ngFor", "ngForOf"], [1, "studio-card"], [4, "ngFor", "ngForOf"]],
        template: function StudioMainPageComponent_Template(rf, ctx) {
          if (rf & 1) {
    ...
    function vUh(module, __webpack_exports__, __webpack_require__) {
      ...
      HomeComponent.ɵfac = function HomeComponent_Factory(t) {
        return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_fire_auth__WEBPACK_IMPORTED_MODULE_1__["AngularFireAuth"]));
      };
    ...
    /***/
    function CXgp(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "StudioNewComponent", function () {
        return StudioNewComponent;
      });
      /* harmony import */
      ...
      var _services_studio_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../services/studio.service */
      "TMz6");
      /* harmony import */
      ...
      function StudioNewComponent_mat_option_16_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function StudioNewComponent_div_27_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StudioNewComponent_div_27_Template_button_click_6_listener() {
            ...
            return ctx_r4.deleteService(service_r3.title, service_r3.description);
          });
      ...
      var StudioNewComponent = /*#__PURE__*/function () {
        function StudioNewComponent(studioService, router) {
          _classCallCheck(this, StudioNewComponent);
        ...
        _createClass(StudioNewComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "addStudio",
          value: function addStudio() {
            console.log(this.studioForm);
            console.log(this.newStudio);
            this.newStudio.location = this.studioForm.value.location, this.newStudio.type = this.studioForm.value.type, this.newStudio.ownerUsername = this.studioForm.value.ownerUsername, this.newStudio.studioName = this.studioForm.value.studioName, //console.log(this.newStudio)
          ...
          key: "deleteService",
          value: function deleteService(title, description) {
            this.newStudio.service = this.newStudio.service.filter(function (service) {
              return !(service.title === title && service.description === description);
            });
          }
        }, {
          key: "onFileChange",
      ...
      StudioNewComponent.ɵfac = function StudioNewComponent_Factory(t) {
        return new (t || StudioNewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_studio_service__WEBPACK_IMPORTED_MODULE_2__["StudioService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
      };

      StudioNewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: StudioNewComponent,
        selectors: [["app-studio-new"]],
        decls: 49,
        vars: 4,
        consts: [[1, "main-content"], [1, "blurred-background"], ["type", "", 3, "formGroup", "ngSubmit"], ["appearance", "outline"], ["autocomplete", "off", "formControlName", "studioName", "type", "text", "matInput", "", "placeholder", "Nazwa zak\u0142adu"], ["formControlName", "type"], [3, "value", 4, "ngFor", "ngForOf"], ["autocomplete", "off", "formControlName", "location", "type", "text", "matInput", "", "placeholder", "Lokalizacja"], ["autocomplete", "off", "formControlName", "ownerUsername", "type", "text", "matInput", "", "placeholder", "W\u0142a\u015Bciciel"], ["class", "studio-card", 4, "ngFor", "ngForOf"], [1, "services-card"], ["autocomplete", "off", "formControlName", "title", "type", "text", "matInput", "", "placeholder", "Tytu\u0142"], ["autocomplete", "off", "formControlName", "description", "type", "text", "matInput", "", "placeholder", "Opis"], ["mat-raised-button", "", "color", "primary"], [3, "value"], [1, "studio-card"], ["mat-raised-button", "", "color", "warn", 3, "click"]],
        template: function StudioNewComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function StudioNewComponent_Template_form_ngSubmit_5_listener() {
              return ctx.addStudio();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function StudioNewComponent_Template_form_ngSubmit_29_listener() {
    ...
    /***/
    function KqQ4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function NavbarComponent_li_18_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, " Za\u0142\xF3\u017C konto");
      ...
      function NavbarComponent_li_23_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NavbarComponent_li_23_Template_li_click_0_listener() {
      ...
      var _c0 = function _c0() {
        return ["/studio-main-page", "all"];
      };

      var _c1 = function _c1() {
        return ["/studio-main-page", "hairdresser"];
      };

      var _c2 = function _c2() {
        return ["/studio-main-page", "makeup"];
      };
      ...
      NavbarComponent.ɵfac = function NavbarComponent_Factory(t) {
        return new (t || NavbarComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_fire_auth__WEBPACK_IMPORTED_MODULE_1__["AngularFireAuth"]));
      };
    ...
    function QX6l(module, __webpack_exports__, __webpack_require__) {
      ...
      DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 4,
        vars: 0,
        consts: [["mat-raised-button", "", "color", "primary", "routerLink", "/home"]],
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        directives: [src_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_1__["NavbarComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterOutlet"]],
    ...
    /***/
    function TMz6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "StudioService", function () {
      ...
      var StudioService = /*#__PURE__*/function () {
        function StudioService(db, router) {
        ...
        _createClass(StudioService, [{
          ...
          key: "addStudio",
          value: function addStudio(studio) {
            var _this7 = this;

            this.getNewId().then(function (newId) {
              _this7.db.list('studios').set(newId.toString(), studio).then(function () {
                _this7.router.navigate(['/studio-main-page', studio.type]);
          ...
          value: function getNewId() {
            ...
            return new Promise(function (resolve, reject) {
              _this8.db.list('studios').query.once('value').then(function (snapshot) {
                var highestNumber = 0;
                snapshot.forEach(function (userSnapshot) {
                  var userId = parseInt(userSnapshot.key, 10);
      ...
      StudioService.ɵfac = function StudioService_Factory(t) {
        return new (t || StudioService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_database__WEBPACK_IMPORTED_MODULE_1__["AngularFireDatabase"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
      };

      StudioService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
        token: StudioService,
        factory: StudioService.ɵfac,
        providedIn: 'root'
      });
      /***/
    },
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _studio_studio_main_page_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./studio/studio-main-page.component */
      "8sfI");
      /* harmony import */
      ...
      var _app_environments_environment__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      ...
      var src_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! src/navbar/navbar.component */
      "KqQ4");
      /* harmony import */


      var _studio_studio_new_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ./studio/studio-new.component */
      "CXgp");
      /* harmony import */
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_18__["ɵɵdefineInjector"]({
        providers: [],
        imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_1__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_9__["AngularFireModule"].initializeApp(_app_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].firebaseConfig), _angular_material_select__WEBPACK_IMPORTED_MODULE_12__["MatSelectModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_13__["MatButtonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_14__["MatCardModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_15__["MatInputModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["ReactiveFormsModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_18__["ɵɵsetNgModuleScope"](AppModule, {
          declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_4__["HomeComponent"], _signup_signup_component__WEBPACK_IMPORTED_MODULE_5__["SignupComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_6__["LoginComponent"], _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_7__["DashboardComponent"], src_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_16__["NavbarComponent"], _studio_studio_main_page_component__WEBPACK_IMPORTED_MODULE_8__["StudioMainPageComponent"], _studio_studio_new_component__WEBPACK_IMPORTED_MODULE_17__["StudioNewComponent"]],
          imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_1__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_9__["AngularFireModule"], // imports firebase/app needed for everything
          _angular_material_select__WEBPACK_IMPORTED_MODULE_12__["MatSelectModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_13__["MatButtonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_14__["MatCardModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_15__["MatInputModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["ReactiveFormsModule"]]
        });
      })();
      /***/
      ...
      var AuthService = /*#__PURE__*/function () {
        function AuthService(router, afAuth) {
          ...
          this.afAuth.onAuthStateChanged(function (user) {
            if (user) {
              _this9.userLoggedIn = true;
            } else {
              _this9.userLoggedIn = false;
            }
          });
        }
        ...
        _createClass(AuthService, [{
          ...
          value: function loginUser(email, password) {
            return this.afAuth.signInWithEmailAndPassword(email, password).then(function () {
    ...
    function rd1V(module, __webpack_exports__, __webpack_require__) {
      ...
      var SignupComponent = /*#__PURE__*/function () {
        function SignupComponent(authService, router, afAuth) {
        ...
        _createClass(SignupComponent, [{
          ...
          value: function signup() {
            ...
            if (this.signupForm.invalid) // if there's an error in the form, don't submit it
              return;
            this.authService.signupUser(this.signupForm.value).then(function (result) {
              if (result == null) // null is success, false means there was an error
                _this10.router.navigate(['/studio-main-page', 'all']);else if (result.isValid == false) {
                _this10.firebaseErrorMessage = result.message;
              }
            })["catch"](function () {});
          }
        }]);
      ...
      SignupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function SignupComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](4, "Utw\xF3rz nowe konto");
    ...
    function vY5A(module, __webpack_exports__, __webpack_require__) {
      ...
      var _studio_studio_main_page_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./studio/studio-main-page.component */
      "8sfI");
      /* harmony import */


      var _studio_studio_new_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./studio/studio-new.component */
      "CXgp");
      /* harmony import */
      ...
      var routes = [{
        path: '',
        redirectTo: 'studio-main-page/all',
        pathMatch: 'full'
      }, {
        path: 'studio-main-page/:studioType',
        component: _studio_studio_main_page_component__WEBPACK_IMPORTED_MODULE_6__["StudioMainPageComponent"]
      }, {
        path: 'studio-new',
        component: _studio_studio_new_component__WEBPACK_IMPORTED_MODULE_7__["StudioNewComponent"],
    ...
    function vtpD(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_studio_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../services/studio.service */
      "TMz6");
      /* harmony import */
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(authService, router, afAuth, studioService) {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function loginUser() {
            ...
            this.authService.loginUser(this.loginForm.value.email, this.loginForm.value.password).then(function (result) {
              if (result == null) {
                // null is success, false means there was an error
                console.log('logging in...');

                _this11.router.navigate(['/studio-main-page', 'all']); // when the user is logged in, navigate them to dashboard

              } else if (result.isValid == false) {
                console.log('login error', result);
                _this11.firebaseErrorMessage = result.message;

                _this11.router.navigate(['/studio-main-page', 'all']);
              }
            });
          }
        }]);
      ...
      LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 19,
        vars: 2,
        consts: [[1, "main-content"], [1, "blurred-background"], ["type", "", 3, "formGroup", "ngSubmit"], ["appearance", "outline"], ["autocomplete", "off", "formControlName", "email", "type", "email", "matInput", "", "placeholder", "Email"], ["autocomplete", "off", "formControlName", "password", "type", "password", "matInput", "", "placeholder", "Has\u0142o"], ["class", "error-style", 4, "ngIf"], ["mat-raised-button", "", "color", "primary"], [1, "error-style"]],
    ...
    function zUnb(module, __webpack_exports__, __webpack_require__) {
      ...
      var _src_app_environments_environment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
